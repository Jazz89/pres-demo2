...
class Angarthemeconfigurator extends Module
{
    public function __construct()
    {
        ...
        $this->displayName = $this->l('AT - 2. Layout and colors live configurator');
    ...
    public function install()
    {
        return parent::install()
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS15', 'submenu2')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS35', 'product_hide_condition1')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS36', 'product_hide_print2')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS40', 'bg_inner_yes')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS44', '0')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR1', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR2', '#d6d4d4')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR3', '#000000')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR4', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR5', '#cda85c')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR6', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR7', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR8', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR9', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR59', '#1b1a1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR10', '#cda85c')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR11', '#1b1a1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR12', '#363636')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR13', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR14', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR15', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR16', '#cda85c')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR17', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR18', '#cda85c') // Price left column not used

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR19', '#cda85c')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR20', '#000000')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR21', '#282828')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR22', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR23', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR24', '#1b1b1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR25', '#d6d4d4')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR26', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR27', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR28', '#cda85c')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR29', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR30', '#1b1a1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR31', '#363636')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR32', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR33', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR34', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR35', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR36', '#1b1a1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR37', '#363636')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR38', '#ffffff')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR39', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR40', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR41', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR42', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR43', '#282828')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR44', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR45', '#282828')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR46', '#cda85c')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR47', '#43b754') // Other buttons
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR48', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR49', '#399a49')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR50', '#3aa04c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR51', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR52', '#196f28')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR53', '#6f6f6f')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR54', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR55', '#5f5f5f')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR56', '#5a5a5a')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR57', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR58', '#4c4c4c')

            // Featured categories
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR60', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR61', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR62', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR63', '#1b1b1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR64', '#d6d4d4')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR65', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR66', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR67', '#cda85c')

            // Products from category
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR68', '#cda85c')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR69', '#cda85c') // Price color not used
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR70', '#cda85c') // New label not used

            // Featured manufacturers
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR71', '#cda85c')
    ...
    public function hookDisplayHeader($params)
    {
        ...
        $this->context->controller->addCSS($this->_path.'views/css/home_styles.css');
        $this->context->controller->addCSS($this->_path.'views/css/home_modyficators.css');
        $this->context->controller->addCSS($this->_path.'views/css/rwd.css');

        if ($this->page_name == 'category') {
            $this->context->controller->addCSS($this->_path.'views/css/category_styles.css');
        }

        if ($this->page_name == 'product') {
            $this->context->controller->addCSS($this->_path.'views/css/product_styles.css');
            $this->context->controller->addCSS($this->_path.'views/css/product_modyficators.css');
        }
    ...
    public function renderForm()
    {
        $fields_form = array(
            'form' => array(
                ...
                $this->l('Documentation: Theme layout editor - https://angarthemes.eu/en/content/16-theme-layout-editor').'<br/>'.
                $this->l('Documentation: Theme color editor - https://angarthemes.eu/en/content/17-theme-color-editor'),
                'input' => array(
